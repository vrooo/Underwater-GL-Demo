...
void main()
{
    vec4 actualPos = M * vec4(position, 1.0f);
    ...
    for (int i = 0; i < waveCount; i++)
    {
        ...
        float phase = kVec.x * actualPos.x + kVec.y * actualPos.z - omega * t + phShift;
    ...
    vec4 worldPos = vec4(actualPos.x - accX, accY, actualPos.z - accZ, 1.0f);
    world = worldPos.xyz;
